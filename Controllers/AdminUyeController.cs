...
namespace MvcBlog.Controllers
{
    public class AdminUyeController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "UyeId,KullaniciAdi,Email,Sifre,AdSoyad,YetkiId,Foto")] Uye uye)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UyeId,KullaniciAdi,Email,Sifre,AdSoyad,YetkiId,Foto")] Uye uye)
        {
            if (ModelState.IsValid)
            {
